<template>
  <div class="flex items-center justify-center p-10 mx-auto text-sm text-center text-gray-500">
    <span class="items-center hidden px-3 sm:inline-flex">
      ...
      by
      <a class="ml-1 text-gray-500 underline" rel="noopener" href="https://www.alfonsobribiesca.com/" target="_blank">Alfonso Bribiesca</a>
    </span>
    <nuxt-link to="/about" class="px-3 text-gray-500 underline border-gray-700 sm:border-l">
      About
    </nuxt-link>
    <a rel="noopener" href="https://github.com/alfonsobries/movjs" target="_blank" class="inline-flex items-center px-3 text-gray-500 underline border-l border-gray-700">
